...
function getWProduct()
{
    ...
    while ($row_products = mysqli_fetch_array($run_products)) {
        ...
        <div class='pi-pic' style='max-height:500px'>
            <img src='img/products/$product_img1' alt='$product_title'>
            <ul>
                <li class='quick-view'><a href='product.php?product_id=$products_id' style='background:#668d94;color:white'>View Details</a></li>
            </ul>
        </div>
        <div class='pi-text'>
            ...
            <div class='product-price' style='color:#668d94'>
               NRP$product_price
            </div>
        </div>
    </div>
...
function getPcatProd()
{
    ...
    if (isset($_GET['p_cat_id'])) {
        ...
        if ($count == 0) {
            ...
            echo "
                <div class='card' style='font-weight:bold; color:#668d94'>
...
function getcatProd()
{
    ...
    if (isset($_GET['cat_id'])) {
        ...
        if ($count == 0) {
            ...
            echo "
                <div class='card' style='font-weight:bold; color:#668d94b'>
                    <div class='card-body'>No Products Available</div>
                </div>
...
function getProd()
{
    ...
    <div class='col-lg-6' style='margin:0 auto'>
        <div class='product-pic-zoom  col-md-8' style='max-height:500px;margin: 0 0 30px 0'>
    ...
    <div class='col-lg-6'>
        <div class='product-details'>
            ...
            <div class='pd-desc'>
                <p>$product_desc</p>
                <h4 style='color:#668d94'>NRP $product_price</h4>
            </div>
        ...
        <div class='col-lg-3 col-sm-6'>
            <div class='product-item' >
                <div class='pi-pic' style='max-height:500px'>
                    ...
                    <ul>
                        <li class='quick-view'><a href='product.php?product_id=$p_id' style='background:#668d94;color:white'>View Details</a></li>
                    </ul>
                </div>
                <div class='pi-text'>
                    <a href='#'>
...
function cart_items()
{
    ...
    <div class='card col-md-3 col-10' style='margin:0 auto; border-radius:25px 5px;box-shadow: inset -12px -8px 40px #668d94;'>
        <div class='card-body'>
        ...
        <tr style='border-bottom: 0.5px solid #668d94'>
           ...
           <td class='p-price first-row'>NRP $pro_price</td>
           ...
           <td class='total-price first-row'>NRP $pro_total_p</td>
...
function cart_icon_prod()
{
    ...
    if (mysqli_num_rows($run_items) == 0) {
        ...
        <p style='text-align:center; font-weight:500;color:#668d94'>Cart Empty </p>
...
function checkoutProds()
{
    ...
    if (mysqli_num_rows($run_items) == 0) {
        ...
        <li class='fw-normal' style='text-align:center;font-weight:bold;font-size:larger;color:#668d94'>No Items in Cart</li>
