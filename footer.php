        ...
        <div class="row" style="padding-bottom: 40px;">
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="index.php"> <span style="color:aquamarine; font-family:Arial, Helvetica, sans-serif ;">D Decor</span>
                        </a>
                    </div>
                    <ul>
                        <li>1234567890</li>
                        <li>ddecor.@gmail.com</li>
            ...
            <div class="col-lg-4">
                <div class="newslatter-item">
                    ...
                    <form action="index.php" class="subscribe-form" style="color:aquamarine">
