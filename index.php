                ...
                <div class='container'>
                    <div class='row'>
                        <div class='col-lg-5'>
                            ...
                            <a href='shop.php' class='primary-btn' style='background:#668d94' >Shop Now</a>
                        </div>
                    </div>
                    <div class='off-card' style='background:#668d94'>
                        <h2>Up to <span>20%</span></h2>
                    </div>  
                </div>
            </div>
                ";
            ...
            <div class="col-lg-4">
                <a href='shop.php?cat_id=1'>
                    <div class="single-banner">
                        <img src="img/banner-1.jpg" alt="Mens">
...
<section class="women-banner spad">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3">
                <div class="product-large set-bg" data-setbg="img/blarge.jpg">
                    <h2>Bedroom</h2>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-3 offset-lg-1">
                <div class="product-large set-bg m-large" data-setbg="img/large.jpg">
                    <h2>Living Room</h2>
